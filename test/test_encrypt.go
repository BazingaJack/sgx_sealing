...
func test_encrypt(num int) error {
	// 开始计时
	startTime := time.Now()
...
func main() {
	...
	if err := test_encrypt(100); err != nil {
		ErrorLogger.Printf("Failed to encrypt: %v", err)
	} else {
		InfoLogger.Printf("Encrypt successfully!")
	}
